...
sample_audios=glob("/home/buket/Desktop/codes/kovanstaj/emotion_recognition/speech_demo/EMODB/*.wav")
...
emo_db_dict={"W":"angry","L":"neutral","E":"disgusted","A":"fear","F":"happy","T":"sad","N":"neutral"} #for emodb
...
labels_list=["angry","neutral","disgusted","fear","happy","sad"]
...
for audio_path in sample_audios:
    print(i,"/",lenght)
    i+=1
    ground_truth=emo_db_dict[audio_path[-6]]
